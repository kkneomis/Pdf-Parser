...
# This module is modified from https://github.com/jshlbrd/laikaboss-modules/blob/master/explode_pdf/explode_pdf.py
    ...
    def _run(self, scanObject, result, depth, args):
        ...
        try:
            ...
            for metaItem in docInfo:
                scanObject.addMetadata(self.module_name, metaItem[1:], str(docInfo[metaItem]))
